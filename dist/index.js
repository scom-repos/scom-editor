...
define("@scom/scom-editor/components/index.css.ts", ["require", "exports", "@ijstech/components"], function (require, exports, components_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.settingStyle = exports.buttonHoverStyle = void 0;
...
define("@scom/scom-editor/components/utils.ts", ["require", "exports", "@ijstech/components", "@scom/scom-editor/global/index.ts", "@scom/scom-editor/components/index.css.ts"], function (require, exports, components_2, index_1, index_css_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getChartTypeOptions = exports.ChartTypes = exports.getWidgetEmbedUrl = exports.WidgetMapping = exports.MediaBlockTypes = exports.CustomBlockTypes = exports.getPlacement = exports.getModalContainer = exports.createModal = exports.createParent = exports.createButton = exports.getExtraFields = exports.defaultBlockTypeItems = void 0;
...
define("@scom/scom-editor/components/dragHandle.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-editor/components/utils.ts"], function (require, exports, components_9, utils_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-editor/components/settingsForm.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-editor/components/index.css.ts", "@scom/scom-editor/components/utils.ts"], function (require, exports, components_10, index_css_2, utils_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let ScomEditorSettingsForm = class ScomEditorSettingsForm extends components_10.Module {
        ...
        render() {
            return (this.$render("i-panel", { padding: { top: '1rem', bottom: '1rem', left: '1rem', right: '1rem' } },
                ...
                this.$render("i-vstack", { id: "pnlForm", gap: '0.625rem', width: '100%', visible: false, class: index_css_2.settingStyle })));
        }
    };
...
define("@scom/scom-editor/components/sideMenu.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-editor/components/settingsForm.tsx", "@scom/scom-editor/components/utils.ts", "@scom/scom-editor/components/index.css.ts"], function (require, exports, components_11, settingsForm_1, utils_7, index_css_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        render() {
            return (this.$render("i-panel", null,
                this.$render("i-hstack", { verticalAlignment: "center", minWidth: 50 },
                    this.$render("i-button", { id: "btnAdd", icon: { name: 'plus', width: '0.75rem', height: '0.75rem', fill: Theme.text.secondary }, background: { color: 'transparent' }, boxShadow: 'none', padding: { top: '0.25rem', bottom: '0.25rem', left: '0.25rem', right: '0.25rem' }, border: { radius: '0.125rem' }, class: index_css_3.buttonHoverStyle, onClick: this.handleAddBlock }),
                    this.$render("i-button", { id: "btnEdit", icon: { name: 'cog', width: '0.75rem', height: '0.75rem', fill: Theme.text.secondary }, background: { color: 'transparent' }, boxShadow: 'none', visible: false, border: { radius: '0.125rem' }, class: index_css_3.buttonHoverStyle, padding: { top: '0.25rem', bottom: '0.25rem', left: '0.25rem', right: '0.25rem' }, onClick: this.handleEditBlock }),
                    this.$render("i-button", { id: "btnDrag", icon: { name: "ellipsis-v", width: '0.75rem', height: '0.75rem', fill: Theme.text.secondary }, background: { color: 'transparent' }, boxShadow: 'none', class: index_css_3.buttonHoverStyle, border: { radius: '0.125rem' }, padding: { top: '0.25rem', bottom: '0.25rem', left: '0.25rem', right: '0.25rem' }, onClick: this.showDragMenu })),
...
define("@scom/scom-editor/components/slashMenu.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-editor/components/utils.ts"], function (require, exports, components_12, utils_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let ScomEditorSlashMenu = class ScomEditorSlashMenu extends components_12.Module {
        ...
        get groupData() {
            ...
            for (let item of this.items) {
                ...
                item.execute = (editor) => {
                    const slashMenu = (0, utils_8.getModalContainer)().querySelector('#mdSlash');
                    if (slashMenu)
...
define("@scom/scom-editor/components/tableToolbar.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-editor/components/utils.ts", "@scom/scom-editor/components/toolbarDropdown.tsx", "@scom/scom-editor/components/index.css.ts"], function (require, exports, components_15, utils_10, toolbarDropdown_1, index_css_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-editor/components/chart.tsx", ["require", "exports", "@ijstech/components"], function (require, exports, components_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let ScomEditorChart = class ScomEditorChart extends components_16.Module {
        static async create(options, parent) {
            let self = new this(parent, options);
            await self.ready();
            return self;
        ...
        async renderChart(data) {
            ...
            if (!this.chartEl || (this.chartEl && name !== this.currentType)) {
                this.chartEl = await components_16.application.createElement(name);
    ...
    ScomEditorChart = __decorate([
        (0, components_16.customElements)('i-scom-editor-chart')
    ], ScomEditorChart);
...
define("@scom/scom-editor/blocks/addVideoBlock.ts", ["require", "exports", "@ijstech/components", "@scom/scom-editor/components/index.ts", "@scom/scom-editor/blocks/utils.ts"], function (require, exports, components_19, index_8, utils_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-editor/blocks/addImageBlock.ts", ["require", "exports", "@ijstech/components", "@scom/scom-editor/components/index.ts", "@scom/scom-editor/blocks/utils.ts"], function (require, exports, components_20, index_9, utils_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-editor/blocks/addChartBlock.ts", ["require", "exports", "@ijstech/components", "@scom/scom-editor/global/index.ts", "@scom/scom-editor/components/index.ts", "@scom/scom-editor/blocks/utils.ts"], function (require, exports, components_21, index_11, index_12, utils_15) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const addChartBlock = (blocknote) => {
        const ChartBlock = blocknote.createBlockSpec({
            ...
            propSchema: {
                ...blocknote.defaultProps,
                name: { default: 'scom-line-chart', values: [...index_12.ChartTypes] },
                apiEndpoint: { default: '' },
            ...
            renderInnerHTML: (attrs) => {
                const link = document.createElement("a");
                const url = (0, index_12.getWidgetEmbedUrl)({
                    type: 'chart',
                    props: { ...(attrs || {}) }
                });
                link.setAttribute("href", url);
...
define("@scom/scom-editor/blocks/addSwapBlock.ts", ["require", "exports", "@ijstech/components", "@scom/scom-editor/global/index.ts", "@scom/scom-editor/components/index.ts", "@scom/scom-editor/blocks/utils.ts"], function (require, exports, components_22, index_13, index_14, utils_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-editor", ["require", "exports", "@ijstech/components", "@scom/scom-editor/blocks/index.ts", "@scom/scom-editor/components/index.ts", "@scom/scom-editor/blocks/addSwapBlock.ts", "@scom/scom-editor/index.css.ts"], function (require, exports, components_24, index_15, index_16, addSwapBlock_1, index_css_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
